    ...
    return  Scaffold(
      ...
      body: SafeArea(
        child:
          Column(
            children: [
              Image(image: AssetImage("assets/crypto (2).jpeg")),SizedBox(height: 10),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
          ...
          Column(
            children: [
              Image(image: AssetImage("assets/Bestcoins.jpg")),SizedBox(height: 10),
              SizedBox(height: 40),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
          ...
          Column(
            children: [
              Image(image: AssetImage("assets/Fast.jpg")),SizedBox(height: 5),
